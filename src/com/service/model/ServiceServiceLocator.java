...
public class ServiceServiceLocator extends org.apache.axis.client.Service implements com.service.model.ServiceService {
    ...
    private java.lang.String service_address = "http://localhost:8080/WebService/services/service";
    ...
    public com.service.model.Service getservice(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.service.model.ServiceSoapBindingStub _stub = new com.service.model.ServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.service.model.Service.class.isAssignableFrom(serviceEndpointInterface)) {
                com.service.model.ServiceSoapBindingStub _stub = new com.service.model.ServiceSoapBindingStub(new java.net.URL(service_address), this);
                _stub.setPortName(getserviceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://model.service.com", "serviceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://model.service.com", "service"));
        }
